...
[![codecov](https://codecov.io/gh/mrandyaswin/fastapi-template/branch/main/graph/badge.svg?token=fastapi-template_token_here)](https://codecov.io/gh/mrandyaswin/fastapi-template)
[![CI](https://github.com/mrandyaswin/fastapi-template/actions/workflows/main.yml/badge.svg)](https://github.com/mrandyaswin/fastapi-template/actions/workflows/main.yml)

Awesome fastapi_template created by mrandyaswin

## Install

from source
```bash
git clone https://github.com/mrandyaswin/fastapi-template fastapi_template
cd fastapi_template
make install
```
